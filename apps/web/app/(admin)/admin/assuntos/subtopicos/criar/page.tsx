...
export default function CriarSubtopicoPage() {
    return (
        <div className="flex-1 space-y-8 p-8 pt-6 animate-in fade-in slide-in-from-bottom-4 duration-700 bg-background min-h-[100vh] rounded-xl md:min-h-min mx-auto w-full max-w-4xl">
            ...
            <div className="flex flex-col gap-6">
                <Link href="/admin/assuntos/subtopicos" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors w-fit">
                    <ChevronLeft className="w-4 h-4" />
                    Voltar para Lista de Subtópicos
                </Link>
            ...
            <div className="bg-card dark:bg-muted/10 border border-border/40 rounded-[2.5rem] p-10 space-y-10 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-sm font-black uppercase tracking-widest text-foreground">Hierarquia de Itens</h3>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select>
                                ...
                                <SelectContent className="rounded-xl border-border/40 shadow-2xl">
                                    {ASSUNTOS_MOCK.filter(a => !a.parentId).map((a) => (
                            ...
                            <div className="flex items-center justify-between p-4 bg-muted/5 rounded-2xl border border-border/20">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="space-y-0.5">
                                        <p className="text-xs font-black text-foreground">Status do Subtópico</p>
                                        <p className="text-[10px] font-medium text-muted-foreground/60">Define se o sub-item aparecerá na árvore de filtros do aluno.</p>
                                    </div>
                                </div>
