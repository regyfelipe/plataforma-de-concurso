            ...
            <div className="bg-card dark:bg-muted/10 border border-border/40 rounded-[2.5rem] p-10 space-y-10 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-sm font-black uppercase tracking-widest text-foreground">Instituições Públicas</h3>
                        <p className="text-[11px] font-medium text-muted-foreground/60 leading-relaxed">
                            Cadastre as instituições responsáveis pela elaboração das provas. A sigla será amplamente utilizada para filtros rápidos de alunos.
                        </p>
                    </div>
