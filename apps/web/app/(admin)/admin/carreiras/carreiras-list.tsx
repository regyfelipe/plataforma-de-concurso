                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                Você está prestes a excluir a carreira <strong className="text-foreground">{item.title}</strong>.
                                        ...
                                        <TableCell colSpan={4} className="h-40 text-center">
                                            <div className="flex flex-col items-center justify-center gap-2">
                                                ...
                                                <p className="text-sm font-medium text-muted-foreground">
                                                    {search ? "Nenhum resultado encontrado." : "Nenhuma carreira cadastrada."}
                                                </p>
                                            </div>
                                        </TableCell>
                                    </TableRow>
