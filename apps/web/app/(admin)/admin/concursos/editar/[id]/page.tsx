...
import { CONCURSOS_MOCK, BANCAS_MOCK, CARREIRAS_MOCK, EDUCACIONAL_MOCK } from "@/data/mocks/admin"

export default function EditarConcursoPage() {
    const params = useParams()
    const id = params.id as string
    
    const concurso = CONCURSOS_MOCK.find((c: any) => c.id === id)

    if (!concurso) {
        return <div className="p-8 text-center text-muted-foreground">Concurso não encontrado.</div>
    }
            ...
            <div className="bg-card dark:bg-muted/10 border border-border/40 rounded-[2.5rem] p-10 space-y-10 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-sm font-black uppercase tracking-widest text-foreground">Ajuste de Certame</h3>
                        <p className="text-[11px] font-medium text-muted-foreground/60 leading-relaxed">
                            Mantenha os dados do concurso precisos. Alterar a banca ou o ano pode afetar a organização das questões para os alunos.
                        </p>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Select defaultValue={concurso.banca}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Select defaultValue={concurso.carreira}>
                                    <SelectTrigger className="w-full h-12 bg-muted/10 border-border/40 rounded-xl focus:ring-primary/20">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select defaultValue={concurso.escolaridade}>
                                    <SelectTrigger className="h-12 bg-muted/10 border-border/40 rounded-xl focus:ring-primary/20">
                            ...
                            <div className="flex items-center justify-between p-4 bg-muted/5 rounded-2xl border border-border/20">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-[10px] font-medium text-muted-foreground/60">Define se o concurso está ativo para receber questões.</p>
                                    </div>
                                </div>
                                <Switch defaultChecked={concurso.status !== 'encerrado'} />
                            </div>
                        </div>
                    </div>
                </div>
