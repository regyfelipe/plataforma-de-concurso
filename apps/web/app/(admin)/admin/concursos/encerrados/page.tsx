    ...
    return (
        <div className="flex-1 space-y-8 p-8 pt-6 animate-in fade-in duration-700 bg-background min-h-[100vh]">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-wrap items-end justify-between gap-6">
                    <div className="space-y-1">
                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-muted-foreground">Histórico de Certames</p>
            ...
            <div className="bg-card dark:bg-muted/10 border border-border/40 rounded-[2rem] p-8 space-y-6 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="px-4 py-2 bg-muted/10 border border-border/40 rounded-xl flex items-center gap-3">
                            ...
                            <p className="text-sm font-black text-foreground">{encerrados.length}</p>
                        </div>
                ...
                <div className="border border-border/40 rounded-2xl overflow-hidden opacity-80">
                    <Table>
                                ...
                                <TableRow key={item.id} className="group border-border/40 hover:bg-muted/10 transition-colors">
                                    <TableCell className="py-5 px-6">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-muted/10 flex items-center justify-center text-muted-foreground border border-border/40 group-hover:bg-muted group-hover:text-foreground transition-all">
                                                <ClipboardList className="w-4 h-4" />
                                            </div>
                                            <p className="text-xs font-black text-muted-foreground">{item.name}</p>
                                        </div>
                                    </TableCell>
                                    <TableCell className="py-5 px-6">
                                        <div className="flex flex-col gap-1">
                                            <Badge variant="outline" className="w-fit text-[9px] font-black uppercase tracking-tight bg-muted/20 border-border/40 text-muted-foreground/60">
                                                {item.banca}
                                            </Badge>
                                            <p className="text-[10px] font-medium text-muted-foreground/40 flex items-center gap-1">
                                    ...
                                    <TableCell className="py-5 px-6">
                                        <div className="flex flex-col gap-1">
                                            <p className="text-[10px] font-black text-muted-foreground/60 uppercase tracking-tight">{item.carreira}</p>
                                            <p className="text-[9px] font-medium text-muted-foreground/40">{item.escolaridade}</p>
                                        </div>
                                    </TableCell>
                                    <TableCell className="py-5 px-6">
                                                ...
                                                <AlertDialogContent className="rounded-[2.5rem]">
                                                    <AlertDialogHeader>
                                                        <div className="flex items-center gap-3 mb-2">
                                                            ...
                                                            <AlertDialogTitle className="font-black text-2xl tracking-tighter">Excluir do Histórico?</AlertDialogTitle>
                                                        </div>
