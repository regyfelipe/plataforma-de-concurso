            ...
            <div className="bg-card dark:bg-muted/10 border border-border/40 rounded-[2.5rem] p-10 space-y-10 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-sm font-black uppercase tracking-widest text-foreground">Escala de Dificuldade</h3>
                        <p className="text-[11px] font-medium text-muted-foreground/60 leading-relaxed">
                            Defina os níveis que serão atribuídos às questões. O "Slug" é o identificador único que o sistema usará para cálculos de desempenho.
                        </p>
                    </div>
