...
export function DificuldadeList({
    items,
    createAction,
    onDelete,
}: {
    items: DificuldadeItem[]
        ...
        <div className="flex-1 space-y-6 p-8 pt-6 bg-background">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="space-y-1">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-foreground">Níveis de Dificuldade</h1>
                </div>
                {createAction}
            </div>
