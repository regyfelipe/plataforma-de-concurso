...
type RankingPorConcursoClientProps = {
    selectedConcurso: string
    ranking: RankingEntry[]
}

export function RankingPorConcursoClient({ selectedConcurso, ranking }: RankingPorConcursoClientProps) {
    return (
